...
import com.hana.app.repository.user.IntegratedPbRepository;
import com.hana.app.repository.user.IntegratedVipRepository;
import com.hana.app.repository.user.UsersRepository;
import com.hana.security.jwt.JwtTokenProvider;
import com.hana.dto.response.user.PbDto;
...
public class UsersService {
    ...
    public void logout(String accessToken) {
        ...
        // 5. 이후 JwtAuthenticationFilter 에서 redis에 있는 logout 정보를 가지고 와서 접근을 거부
    }
